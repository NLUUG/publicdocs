...
4. Schriftelijk kan zowel per (post)brief, e-mail, als een digitale berichtendienst zijn.
...
### 1. Geldigheid
Het lidmaatschap van de NLUUG wordt automatisch, en alleen dan, actief op het moment dat de lidmaatschapsfactuur volledig betaald is. Voor ereleden geldt de ereledenregeling.

### 2. Lidmaatschapsvormen

1. De vereniging kent natuurlijke personen als lid, met stemrecht.
2. Rechtspersonen kunnen zich aansluiten als donateur, zonder stemrecht.
...
6. De donateursbijdragen zijn samengesteld uit het eenheidslidmaatschapstarief inclusief twee conferenties tegen ledentarief. De bedragen worden vermeld op de website van de vereniging.
7. De volgende verhoudingen in donateursbijdragen liggen vast:

| Donateurschap            |  Type  | Factor | Leden |
| ------------------------ | ------ | ------ | ----- |
| Donateur-1               |    D   |   1    |   1   |
| Donateur-2               |    D   |   2    |   3   |
| Donateur-4               |    D   |   3    |   5   |
| Donateur-8               |    D   |   8    |  11   |
| Donateur-Plus            |    D   |  14    |  18   |

P = Natuurlijk Persoon, D = Donateur, E = Erelid
...
3. Leden kunnen met elkaar in contact treden via een door de vereniging aangeboden communicatiemiddel. Deze communicatiemiddel is uitsluitend toegankelijk voor leden en wordt niet gemodereerd.
4. Leden betalen een lagere toegangsprijs voor de conferentie dan niet-leden.

### 4. Voordelen donateurs
1. Donateur-PLUS organisaties worden vermeld op de website.
2. Donateurs kunnen hun contributie gebruiken om lidmaatschappen (van natuurlijke personen) mee te voldoen, tot een maximum van het aantal leden genoemd in artikel 2.7.
3. Een donateur die minimaal twee keer het eenheidstarief bijdraagt mag elke conferentie iemand aanmelden zonder lidmaatschapsverplichting. Deze persoon wordt opgenomen in de administratie als ‘introducee’ en kan geen tweede keer naar een evenement zonder volwaardig lid te worden.
...
2. Toegang tot de conferenties voor niet-leden die niet onder (5.1) vallen is mogelijk voor een tarief dat gelijk is aan of hoger dan het ledentarief.
3. Het is mogelijk om bij aanmelding voor een conferentie lid te worden. Daarvoor wordt dan de contributie voor het lopende kalenderjaar plus de conferentiedeelnameprijs voor leden gevraagd.
...
1. Een lid dat geschorst is mag uitsluitend deelnemen aan activiteiten van de vereniging (inclusief communicatiemiddel en toegang tot de website) met voorafgaande toestemming van het bestuur.
...
3. Indien de ALV de schorsing niet opheft wordt het erelidmaatschap van de persoon ontnomen. De opheffing van het erelidmaatschap sluit de persoon niet uit van een (eventueel opnieuw af te sluiten) regulier lidmaatschap van de vereniging en de daaraan verbonden rechten en plichten.
...
4. Uitnodiging voor deelname aan het conferentie-diner, indieningeschreven voor de conferentie.
...
uitsluitend in het geval van urgentie 
    ...
    3. Spoed ALVs worden minimaal zeven dagen van te voren aangekondigd schriftelijk aangekondigd aan de leden.
    4. Op een Spoed ALV kan alleen over de onderwerpen van urgentie worden beslist.
    5. Spoed ALVs worden bij voorkeur ’s avonds of in het weekend op een goed bereikbare locatie of een online platform belegd.
2. Normale ALVs
    1. Elke jaar wordt er minimaal één normale ALV georganiseerd, bij voorkeur tijdens een activiteit van de NLUUG.
